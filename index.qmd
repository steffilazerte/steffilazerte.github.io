...
I am the author of [several R packages](R.html) providing a variety of services from accessing historical weather data from Environment and Climate Change Canada's website ([`weathercan`](https://github.com/ropensci/weathercan)) to mapping the flow of water through a landscape ([`LITAP`](https://github.com/FRDC-SHL/LITAP)) to transforming and visualizing animal movement data ([`feedr`](https://github.com/animalnexus/feedr)).
...
[Twitter](https://twitter.com/steffilazerte)|<a rel="me" href="https://fosstodon.org/@steffilazerte">Mastodon</a>|[Email](mailto:sel@steffilazerte.ca)
