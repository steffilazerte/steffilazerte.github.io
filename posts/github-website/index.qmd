...
date: "2023-08-23"
toc: true
categories: [github, website, profiles]
---
...
So if you find it tricky, that's normal :)
...
You need a server to *serve* or *host* the files and generally[^1] you go through 
an external company to do this for you (i.e. a Hosting service, or GitHub). 
...
- Make sure you're working with a folder (project or repository) called `yourgithubusername.github.io`
...
most straightforward way is to 'render' your site into a `docs` folder and then
...
use `quarto preview` in the terminal, or, [render your website](https://quarto.org/docs/websites/#website-render) and then open the `index.html` file inside the `docs` folder 
(in this case you will to re-render and refresh the page to see new changes).
...
[^3]: In the sense that there are other, more complex things you can do, not in the sense that this is particularly straightforward
